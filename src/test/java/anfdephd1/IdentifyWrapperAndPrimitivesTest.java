...
public class IdentifyWrapperAndPrimitivesTest {
	IJavaElement javaElement;
	
	@Before
	public void arrange() throws JavaModelException {
		this.javaElement = WorkspaceHelper.getJavaElement("anfdephd1/IdentifyWrapperAndPrimitives.java");
	}
	...
	public void doTest() throws JavaModelException {
		...
		// ASSERT
		assertEquals( 18, FindingResult.getFromCache().getFindings().size());
	}
