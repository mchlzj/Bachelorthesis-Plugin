...
public class DontIdentifyPtimitivesOrObjectsInReturnStmtTest {
	IJavaElement javaElement;
	
	@Before
	public void arrange() throws JavaModelException {
		this.javaElement = WorkspaceHelper.getJavaElement("anfdephd1/anfdephd1b/DontIdentifyPtimitivesOrObjectsInReturnStmt.java");
	}
	...
	public void doTest() throws JavaModelException {
		...
		// ASSERT
		assertEquals( 0, FindingResult.getFromCache().getFindings().size());
	}
