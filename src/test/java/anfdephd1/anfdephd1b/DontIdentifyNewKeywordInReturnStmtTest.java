...
public class DontIdentifyNewKeywordInReturnStmtTest {
	IJavaElement javaElement;
	
	@Before
	public void arrange() throws JavaModelException {
		this.javaElement = WorkspaceHelper.getJavaElement("anfdephd1/anfdephd1b/DontIdentifyNewKeywordInReturnStmt.java");
	}
