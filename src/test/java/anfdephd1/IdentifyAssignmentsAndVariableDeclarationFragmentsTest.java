...
public class IdentifyAssignmentsAndVariableDeclarationFragmentsTest {
	IJavaElement javaElement;
	
	@Before
	public void arrange() throws JavaModelException {
		this.javaElement = WorkspaceHelper.getJavaElement("anfdephd1/IdentifyAssignmentsAndVariableDeclarationFragments.java");
	}
