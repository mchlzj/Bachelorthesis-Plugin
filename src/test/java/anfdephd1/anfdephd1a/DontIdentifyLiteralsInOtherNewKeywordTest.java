...
public class DontIdentifyLiteralsInOtherNewKeywordTest {

	IJavaElement javaElement;
	
	@Before
	public void arrange() throws JavaModelException {
		this.javaElement = WorkspaceHelper.getJavaElement("anfdephd1/anfdephd1a/DontIdentifyLiteralsInOtherNewKeyword.java");
	}
