...
public class DontIdentifyRecursiveMethodUseTest {
	IJavaElement javaElement;
	
	@Before
	public void arrange() throws JavaModelException {
		this.javaElement = WorkspaceHelper.getJavaElement("anfdephd1/anfdephd1a/DontIdentifyRecursiveMethodUse.java");
	}
