...
public class DontIdentifyParamAsNoDependencyTest {
	IJavaElement javaElement;
	
	@Before
	public void arrange() throws JavaModelException {
		this.javaElement = WorkspaceHelper.getJavaElement("anfdepnd1a/DontIdentifyParamAsNoDependency.java");
	}
	...
	public void doTest() throws JavaModelException {
		...
		// ASSERT
		assertEquals( 0, FindingResult.getFromCache().getNoDependencyFindings().size());
	}
