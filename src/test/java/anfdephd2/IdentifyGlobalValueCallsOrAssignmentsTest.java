...
public class IdentifyGlobalValueCallsOrAssignmentsTest {
	IJavaElement javaElement;
	
	@Before
	public void arrange() throws JavaModelException {
		this.javaElement = WorkspaceHelper.getJavaElement("anfdephd2/IdentifyGlobalValueCallsOrAssignments.java");
	}
