...
public class DontidentifyPrimitiveTypeTest {
	IJavaElement javaElement;
	
	@Before
	public void arrange() throws JavaModelException {
		this.javaElement = WorkspaceHelper.getJavaElement("anfdepid1a/DontidentifyPrimitiveType.java");
	}
	...
	public void doTest() throws JavaModelException {
		...
		// ASSERT
		assertEquals( 7, FindingResult.getFromCache().getNoDependencyFindings().size());
