...
public class IdentifyAssignmentFromInjectableDependencyMethodCallTest {
	IJavaElement javaElement;
	
	@Before
	public void arrange() throws JavaModelException {
		this.javaElement = WorkspaceHelper.getJavaElement("anfdepid1/IdentifyAssignmentFromInjectableDependencyMethodCall.java");
	}
	...
	public void doTest() throws JavaModelException {
		...
		// ASSERT
		assertEquals( 2, FindingResult.getFromCache().getInjectableFindings().size());
	}
