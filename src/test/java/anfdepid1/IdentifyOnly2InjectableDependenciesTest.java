...
public class IdentifyOnly2InjectableDependenciesTest {
	IJavaElement javaElement;
	
	@Before
	public void arrange() throws JavaModelException {
		this.javaElement = WorkspaceHelper.getJavaElement("anfdepid1/IdentifyOnly2InjectableDependencies.java");
	}
