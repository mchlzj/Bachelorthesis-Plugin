...
public class IdentidyPrimitivesAndInterfacesAsMockableDependenciesTest {
	IJavaElement javaElement;
	
	@Before
	public void arrange() throws JavaModelException {
		this.javaElement = WorkspaceHelper.getJavaElement("anfdepmd1/IdentidyPrimitivesAndInterfacesAsMockableDependencies.java");
	}
	...
	public void doTest() throws JavaModelException {
		...
		// ASSERT
		assertEquals( 2, FindingResult.getFromCache().getMockableFindings().size());
